...
import CompiladorChelero.TipoToken;
            ...
            switch (estado) {
                ...
                case 10:
                    if (Character.isLetterOrDigit(Caracter)) Palabra.append(Caracter);
                        ...
                        if (a == null){
                            Tokens.add(new Token(TipoToken.IDENTIFIER,NuevoLexema,null,linea));
                        }
                        else{
                ...
                case 11:
                    ...
                    else Tokens.add(new Token(TipoToken.IDENTIFIER,NuevoLexema,null,linea));*/
                    estado = 9;
                    i=retractar(i);
                    break;
                case 12:
                    if (Character.isDigit(Caracter)) Palabra.append(Caracter);
                        ...
                        Palabra.setLength(0);
                        //System.out.println(NuevoLexema);
                        Tokens.add(new Token(TipoToken.NUMBER,NuevoLexema,Double.valueOf(NuevoLexema),linea));
                        estado = 9;
                        i=retractar(i);
                    }
                    break;
                ...
                case 19:
                    if (Caracter == '"'){
                        ...
                        Palabra.setLength(0);
                        //System.out.println(NuevoLexema);
                        Tokens.add(new Token(TipoToken.STRING,NuevoLexema,NuevoLexema,linea));
                        estado = 9;
                    }else Palabra.append(Caracter);
                    break;
                case 20:
                    Tokens.add(new Token(TipoToken.PLUS,"+",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 21:
                    Tokens.add(new Token(TipoToken.MINUS,"-",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 22:
                    Tokens.add(new Token(TipoToken.STAR,"*",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 23:
                    ...
                    break;
                case 24:
                    Tokens.add(new Token(TipoToken.LEFT_PAREN,"(",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 25:
                    Tokens.add(new Token(TipoToken.RIGHT_PAREN,")",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 26:
                    Tokens.add(new Token(TipoToken.LEFT_BRACE,"{",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 27:
                    Tokens.add(new Token(TipoToken.RIGHT_BRACE,"}",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 28:
                    ...
                    break;
                case 29:
                    Tokens.add(new Token(TipoToken.DOT,".",null,linea));
                    i = retractar(i);
                    estado = 9;
                    break;
                case 30:
                    if (Caracter == '='){
                        estado = 9;
                        Tokens.add(new Token(TipoToken.LESS_EQUAL,"<=",null,linea));
                    }
                    
                    else {
                        estado = 9;
                        Tokens.add(new Token(TipoToken.LESS,"<",null,linea));
                        i = retractar(i);
                    }
                    break;
                case 31:
                    if (Caracter == '='){
                        //estado = 32;
                        Tokens.add(new Token(TipoToken.EQUAL_EQUAL,"==",null,linea));
                        estado = 9;
                    }
                    else {
                        estado = 9;
                        Tokens.add(new Token(TipoToken.EQUAL,"=",null,linea));
                        i = retractar(i);
                    }
                    break;
                case 32:
                ...
                case 33:
                    if (Caracter == '=') {
                        estado = 11;
                        Tokens.add(new Token(TipoToken.GREATER_EQUAL, ">=", null, linea));
                    } else {
                        estado = 12;
                        Tokens.add(new Token(TipoToken.GREATER, ">", null, linea));
                        i = retractar(i);
                    }
                    break;
                case 34:
